    ...
    return(
     ...
     <div className="second">
        ...
        <div className="background-removed">
           <img className="perfume1" src="/perfume-removebg-preview (1).png" alt=""/>
           <img className="perfume2" src="/perfume-removebg-preview (1).png" alt=""/>
 ...
 <div className="five">
    ...
    <div className="six">
      {products.map((item,index) => (
        <div className="six-in" key={item._id}>
          
          <div className={index % 2 === 0 ? "div1" : "div"}>
            <img className="image" src={`http://localhost:5000/uploads/${item.image}`}
            alt={item.name} />
...
{wishlist.some((wish) => wish._id === item._id) ? (
  ...
  />
          ...
          <h3>
            ...
            <span style={{ fontSize: "15px", fontWeight: "100", textDecoration: "line-through" }}>
              Rs {item.oldPrice}
            </span>
          </h3>
    ...
    <div className="six">
      {products.map((item) => (
        <div className="six-in" key={item._id}>
          ...
          <div className={item._id % 2 === 0 ? "div1" : "div"}>
            <img className="image" src={`http://localhost:5000/uploads/${item.image}`}
            alt={item.name} />
           {wishlist.some((wish) => wish._id === item._id) ? (
  <FaHeart className="heart-icon filled" />
